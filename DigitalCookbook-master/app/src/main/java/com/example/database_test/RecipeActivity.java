...
public class RecipeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_recipes_list);
    ...
    private class SubjectHolder extends RecyclerView.ViewHolder
        ...
        public void bind(Subject subject, int position) {
            ...
            if (mSelectedSubjectPosition == position) {
                ...
                mImageView.setImageResource(R.drawable.subbackred2);
            } else {
        ...
        public void onClick(View view) {
            ...
            Intent intent = new Intent(RecipeActivity.this, QuestionActivity.class);
        ...
        public boolean onLongClick(View view) {
            ...
            mActionMode = RecipeActivity.this.startActionMode(mActionModeCallback);
